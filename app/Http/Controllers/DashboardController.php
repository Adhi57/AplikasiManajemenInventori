    ...
    public function index(): View
    {
        ...
        $barangTerlaris = Cache::remember('dashboard_barang_terlaris_page_' . $page, now()->addMinutes(30), function() {
            return DB::table('lap_barang_keluar as lbk')
                ...
                ->selectRaw('MAX(lbk.lap_keluar_id) as lap_keluar_id,
                    dlk.kode_barang,
                    MAX(b.satuan_jual) as satuan_jual,
                    MAX(b.foto_produk) as foto_produk,
                    MAX(b.nama_barang) as nama_barang,
                    MAX(kb.nama_kategori_barang) as nama_kategori,
