...
<div class="bg-gradient-to-b from-red-900 to-red-950 text-white w-68 space-y-6 py-7 px-4 fixed inset-y-0 left-0 z-40 h-full 
    ...
    Initial state ditentukan oleh apakah ada sub-menu yang aktif --}} x-data="{ 
    ...
    <a href="/dashboard" class="text-sm font-semibold flex items-center gap-3 w-full p-2.5 rounded-xl transition-all duration-200 
    ...
    <nav class="space-y-1">
        ...
        {{-- Group 1: Inventory --}}
        <h3 class="text-red-400 uppercase tracking-wider text-xs font-semibold pt-4 pb-2 border-t border-red-800/50">
            Inventory</h3>
        {{-- Inventori Gudang --}}
        <div>
            ...
            <!-- Isi Dropdown -->
            <div x-show="inventoriGudangOpen" x-transition:enter="transition ease-out duration-300"
                ...
                style="display: none;">
                <a href="/katalog_barang" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150
                    {{ request()->is('katalog_barang*') ? $activeSubLinkClasses : $defaultSubLinkClasses }}">Katalog
                    Barang</a>

                <a href="/stok-barang" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150
                    {{ request()->is('stok-barang*') ? $activeSubLinkClasses : $defaultSubLinkClasses }}">Stok
                    Barang</a>

                <a href="/reorder-point" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150
                    {{ request()->is('reorder-point*') ? $activeSubLinkClasses : $defaultSubLinkClasses }}">Reorder
                    Point</a>

                <a href="/stock_opname" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150
                    {{ request()->is('stock_opname*') ? $activeSubLinkClasses : $defaultSubLinkClasses }}">Stock
                    Opname</a>

                <a href="/tracking-kadaluarsa" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150
                    {{ request()->is('tracking-kadaluarsa*') ? $activeSubLinkClasses : $defaultSubLinkClasses }}">Batch
                    & Tracking Kadaluarsa</a>
            </div>
        </div>

        {{-- Link Navigasi Non-Dropdown --}}

        <a href="{{ route('purchase_orders.buat_permintaan') }}" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
        ...
        <a href="/verifBarang" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
        ...
        <a href="/returBarang" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
        ...
        <h3
            ...
            Surat Jalan & Pengiriman</h3>

        <a href="{{ route('surat_jalan.index') }}" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
            {{ request()->is('surat_jalan*') ? $activeLinkClasses : $defaultLinkClasses }}">
            <i class="fa-solid fa-file-invoice-dollar text-xl w-6"></i>
            <span>Surat Jalan</span>
        </a>

        <a href="/pengiriman" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
        ...
        <a href="{{ route('approval.approval_po') }}" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
        ...
        <a href="{{ route('approval.approval_surat_jalan') }}" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
        ...
        <a href="/laporan/barang-masuk" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
            {{ request()->is('laporan/barang-masuk*') ? $activeLinkClasses : $defaultLinkClasses }}">
            <i class="fa-solid fa-file-export text-xl w-6"></i>
            <span>Laporan Barang Masuk</span>
        </a>

        <a href="/laporan/barang-keluar" class="flex items-center gap-3 text-sm font-medium w-full p-2.5 rounded-xl hover:bg-red-800/70 transition-all duration-200
        ...
        <div>
            ...
            <!-- Isi Dropdown -->
            <div x-show="dataMasterOpen" x-transition:enter="transition ease-out duration-300"
                x-transition:enter-start="opacity-0 max-h-0" x-transition:enter-end="opacity-100 max-h-screen"
                x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 max-h-screen"
                x-transition:leave-end="opacity-0 max-h-0"
                class="origin-top ml-4 border-l-2 border-red-500 pl-4 py-1 space-y-1 overflow-hidden"
                style="display: none;">
                <a href="/barangs" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150 
                    {{ request()->is('barangs*') ? $activeSubLinkClasses : $defaultSubLinkClasses }}">Data Barang</a>

                <a href="/pelanggans" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150 
                ...
                <a href="/suppliers" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150 
                    {{ request()->is('suppliers*') ? $activeSubLinkClasses : $defaultSubLinkClasses }}">Data
                    Supplier</a>

                <a href="/kategori_barang" class="text-sm font-normal block py-1.5 rounded-md pl-2 transition-all duration-150 
