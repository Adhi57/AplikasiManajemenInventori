...
<div class="bg-gradient-to-b from-red-950 to-red-900 border-r border-red-800/50 text-white w-64 md:w-68 space-y-6 py-6 px-4 fixed inset-y-0 left-0 z-40 h-full 
    ...
    <nav class="space-y-1">
        ...
        <a href="/dashboard" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200 
            ...
            <i class="fa-solid fa-layer-group text-lg w-5 text-center {{ request()->is('dashboard') ? 'text-amber-400' : '' }}"></i>
        ...
        <div>
            ...
            <button @click="inventoriGudangOpen = !inventoriGudangOpen"
                ...
                <span class="flex items-center gap-3">
                    <i class="fa-solid fa-boxes-stacked text-lg w-5 text-center {{ $inventoriGudangActive ? 'text-amber-400' : '' }}"></i>
            ...
            <div x-show="inventoriGudangOpen" x-transition:enter="transition ease-out duration-200"
                ...
                class="origin-top ml-5 border-l border-red-800/60 pl-2 mt-1 space-y-1"
                style="display: none;">
                ...
                <a href="/reorder-point" class="block text-[13px] py-2 px-3 rounded-lg transition-all duration-150
                    {{ request()->is('reorder-point*') ? $activeSubLinkClasses : $defaultSubLinkClasses }}">Reorder Point</a>
                ...
                <a href="/tracking-kadaluarsa" class="block text-[13px] py-2 px-3 rounded-lg transition-all duration-150
        ...
        <a href="{{ route('purchase_orders.buat_permintaan') }}" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-money-check-dollar text-lg w-5 text-center {{ request()->is('purchase_orders/buat_permintaan*') ? 'text-amber-400' : '' }}"></i>
        ...
        <a href="/verifBarang" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-clipboard-check text-lg w-5 text-center {{ request()->is('verifBarang*') ? 'text-amber-400' : '' }}"></i>
        ...
        <a href="/returBarang" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-arrow-right-arrow-left text-lg w-5 text-center {{ request()->is('returBarang*') ? 'text-amber-400' : '' }}"></i>
        ...
        <a href="{{ route('surat_jalan.index') }}" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-file-invoice-dollar text-lg w-5 text-center {{ request()->is('surat_jalan*') ? 'text-amber-400' : '' }}"></i>
        ...
        <a href="/pengiriman" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-truck-fast text-lg w-5 text-center {{ request()->is('pengiriman*') ? 'text-amber-400' : '' }}"></i>
        ...
        <a href="{{ route('approval.approval_po') }}" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-file-signature text-lg w-5 text-center {{ request()->is('approval/approval_po*') ? 'text-amber-400' : '' }}"></i>
        ...
        <a href="{{ route('approval.approval_surat_jalan') }}" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-file-signature text-lg w-5 text-center {{ request()->is('approval/approval_surat_jalan*') ? 'text-amber-400' : '' }}"></i>
            <span class="text-sm">Approval SJ</span>
        </a>

        {{-- Group 4: Laporan --}}
        <h3 class="text-red-400/70 uppercase tracking-widest text-[10px] font-bold mt-8 mb-2 px-3">Analytics & Reports</h3>
        ...
        <a href="/laporan/barang-masuk" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-chart-pie text-lg w-5 text-center {{ request()->is('laporan/barang-masuk*') ? 'text-amber-400' : '' }}"></i>
        ...
        <a href="/laporan/barang-keluar" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-chart-line text-lg w-5 text-center {{ request()->is('laporan/barang-keluar*') ? 'text-amber-400' : '' }}"></i>
        ...
        <div>
            ...
            <button @click="dataMasterOpen = !dataMasterOpen"
                ...
                <span class="flex items-center gap-3">
                    <i class="fa-solid fa-database text-lg w-5 text-center {{ $dataMasterActive ? 'text-amber-400' : '' }}"></i>
            ...
            <div x-show="dataMasterOpen" x-transition:enter="transition ease-out duration-200"
                ...
                class="origin-top ml-5 border-l border-red-800/60 pl-2 mt-1 space-y-1"
                style="display: none;">
                <a href="/barangs" class="block text-[13px] py-2 px-3 rounded-lg transition-all duration-150 
                ...
                <a href="/kategori_pelanggan" class="block text-[13px] py-2 px-3 rounded-lg transition-all duration-150 
        ...
        <a href="{{ route('pengaturan.index') }}" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
            ...
            <i class="fa-solid fa-sliders text-lg w-5 text-center {{ request()->is('pengaturan*') ? 'text-amber-400' : '' }}"></i>
        ...
        @if(auth()->user()->role === 'SuperAdmin')
            <a href="/users" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all duration-200
                ...
                <i class="fa-solid fa-users-gear text-lg w-5 text-center {{ request()->is('users*') ? 'text-amber-400' : '' }}"></i>
