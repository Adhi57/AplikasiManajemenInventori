...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white rounded-xl shadow-xs p-6 max-w-xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl text-center font-bold text-gray-800">Tambah Supplier Baru</h1>
        </div>
        ...
        <form action="{{ route('suppliers.store') }}" method="POST">
            ...
            <label for="noTelepon" class="block text-sm font-medium text-gray-700 mb-1">No. Telepon</label>
                ...
                <div>
                <label for="waktuPengiriman" class="block text-sm font-medium text-gray-700 mb-1">Rata-rata Waktu Pengiriman (hari)</label>
                <input
                    type="number"
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('suppliers.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    Batal
                </a>
                <button
                    type="submit"
                    class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Simpan Supplier
                </button>
            </div>
        </form>
