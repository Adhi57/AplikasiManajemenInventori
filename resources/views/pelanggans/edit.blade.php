...
<x-page-header title="Edit Pelanggan" description="Perbarui informasi pelanggan: {{ $pelanggan->nama_pelanggan }}" icon="fa-pen-to-square">
    <x-slot name="actions">
...
<form action="{{ route('pelanggans.update', $pelanggan->pelanggan_id) }}" method="POST" class="space-y-6">
    @csrf
    @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_pelanggan" id="nama_pelanggan"
                                value="{{ old('nama_pelanggan', $pelanggan->nama_pelanggan) }}" placeholder="Nama pelanggan"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="NPWP" id="NPWP" value="{{ old('NPWP', $pelanggan->NPWP) }}" maxlength="20"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="PIC" id="PIC" value="{{ old('PIC', $pelanggan->PIC) }}" maxlength="50"
