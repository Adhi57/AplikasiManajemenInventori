...
@section('content')
    ...
    {{-- Page Header --}}
    <x-page-header title="{{ $isEdit ? 'Edit Barang' : 'Tambah Barang Baru' }}" description="{{ $isEdit ? 'Perbarui informasi barang: ' . $barang->nama_barang : 'Lengkapi data untuk mendaftarkan barang baru' }}" icon="{{ $isEdit ? 'fa-pen-to-square' : 'fa-box' }}">
        <x-slot name="actions">
