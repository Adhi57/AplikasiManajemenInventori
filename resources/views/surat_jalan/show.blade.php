    ...
    <div class="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg print:p-0 print:shadow-none">
        ...
        : '...........' }}
                    ...
                    <p><strong>Nama Pelanggan:</strong>
                        {{ $suratJalan->pelanggan->nama_pelanggan ?? '..............................' }}</p>
            ...
            <table class="min-w-full text-sm text-gray-700 border-collapse">
                ...
                <tfoot class="bg-gray-50 text-gray-800">
                    <tr>
                        ...
                        <td class="text-right py-2 px-3 border-t border-gray-300">
                            {{ 'Rp ' . number_format($subtotal, 2, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td colspan="5" class="text-right font-semibold py-2 px-3 border-t border-gray-300">Biaya Pengiriman
                        </td>
                        <td class="text-right py-2 px-3 border-t border-gray-300">
                            {{ 'Rp ' . number_format($biaya_kirim, 2, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td colspan="5" class="text-right font-semibold py-2 px-3 border-t border-gray-300">Diskon Pelanggan
                        </td>
                        <td class="text-right py-2 px-3 border-t border-gray-300"> -
                            {{ 'Rp ' . number_format($diskon, 2, ',', '.') }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right py-2 px-3 border-t border-gray-300">
                            {{ 'Rp ' . number_format($pajak, 2, ',', '.') }}</td>
                    </tr>

                    <tr>
                        <td colspan="5" class="text-right font-bold py-2 px-3 border-t border-gray-400 text-lg">Total Akhir
                        </td>
                        <td class="text-right font-bold py-2 px-3 border-t border-gray-400 text-lg text-green-700">
        ...
        <div class="grid grid-cols-2 gap-4 text-center text-sm mt-12">
            <div>
                ...
                <p class="mt-4 font-semibold">
                    {{ $suratJalan->user->nama_lengkap ?? '....................................' }}</p>
