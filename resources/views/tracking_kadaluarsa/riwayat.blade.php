...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Riwayat Hapus Stok</h1>
                <p class="text-sm text-gray-500 mt-1">Catatan stok yang dihapus dari tracking kadaluarsa.</p>
            </div>
